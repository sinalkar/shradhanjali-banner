...
The form uses the custom design system plus daisyUI controls. The aspirational spec:
...
- **Form Section:** White background, 10px radius, section ambient shadow (`0 5px 15px rgba(0,0,0,0.1)`). Currently a warm off-white surface (`--form-surface`).
...
- **Don't** use a generic framework's default blue primary or green success colors on any visible button. They carry no meaning in this context and undermine the devotional palette.
